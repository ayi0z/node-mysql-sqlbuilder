...
export declare type DistAllType = 'ALL' | 'DISTINCT';
export declare type JoinOnType = 'FULL' | 'LEFT' | 'RIGHT' | 'INNER';
export declare type IAggrFnType = 'COUNT' | 'SUM' | 'AVG' | 'MAX' | 'MIN';
declare type WhereFieldType = {
    [index: string]: string | number | OperatorType;
};
export declare type WhereArgType = string | {
